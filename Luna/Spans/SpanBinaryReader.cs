...
/// <summary> Equivalent to <see cref="BinaryReader"/>, but for <see cref="ReadOnlySpan{Byte}"/>. </summary>
/// <remarks>
...
public unsafe ref struct SpanBinaryReader
{
    ...
    /// <summary> Create a new <see cref="SpanBinaryReader"/> over the given span. </summary>
    ...
    /// <summary> The total length of the span. </summary>
    public readonly int Length;

    /// <summary> The remaining bytes in the span. </summary>
    ...
    /// <summary> Skip a given number of bytes without reading or parsing them. </summary>
    ...
    /// <summary> Read an unmanaged struct of type <typeparamref name="T"/> from the current position. </summary>
    /// <typeparam name="T"> The unmanaged type to read. </typeparam>
    /// <returns> An instance of the type filled with the byte-wise data from the span. </returns>
    /// <exception cref="EndOfStreamException" />
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    ...
    /// <summary> Read multiple unmanaged structs of type <typeparamref name="T"/> from the current position. </summary>
    /// <typeparam name="T"> The unmanaged type to read. </typeparam>
    /// <param name="num"> The number of structs to read. </param>
    /// <returns> A span of containing <paramref name="num"/> instances of type <typeparam name="T"/>. </returns>
    /// <exception cref="EndOfStreamException" />
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    ...
    /// <summary> Read a single <see cref="byte"/> from the span. </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public byte ReadByte()
        => Read<byte>();

    /// <summary> Read a single <see cref="short"/> from the span. </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public short ReadInt16()
        => Read<short>();

    /// <summary> Read a single <see cref="int"/> from the span. </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public int ReadInt32()
        => Read<int>();

    /// <summary> Read a single <see cref="long"/> from the span. </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public long ReadInt64()
        => Read<long>();

    /// <summary> Read a single <see cref="ushort"/> from the span. </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public ushort ReadUInt16()
        => Read<ushort>();

    /// <summary> Read a single <see cref="uint"/> from the span. </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public uint ReadUInt32()
        => Read<uint>();

    /// <summary> Read a single <see cref="ulong"/> from the span. </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public ulong ReadUInt64()
        => Read<ulong>();

    /// <summary> Read a single <see cref="nint"/> from the span. </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public nint ReadIntPtr()
        => Read<nint>();

    /// <summary> Read a single <see cref="float"/> from the span. </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public float ReadSingle()
        => Read<float>();

    /// <summary> Read a single <see cref="double"/> from the span. </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    ...
    public readonly ReadOnlySpan<byte> ReadByteString(int offset = 0)
    {
        ...
        var idx  = MemoryExtensions.IndexOf<byte>(span, 0);
        if (idx < 0)
            throw new EndOfStreamException();
