...
/// <summary> Represents a pre-configured component that allows to display and/or edit a value, or an array of contiguous values, stored in a region of memory. </summary>
...
public interface IEditor<T> where T : unmanaged
{
    ...
    /// <remarks>
    ///   This function does not handle IDs and does not draw a label. <br/>
    ///   This function honors <see cref="Im.Item.SetNextWidth"/>.
    /// </remarks>
    public bool Draw(Span<T> values, bool disabled);

    /// <summary> Presents this editor as an editor for another stored type. Analogous to <see cref="MemoryMarshal.Cast{TFrom, TTo}(Span{TFrom})"/>. </summary>
    ...
    /// <summary> Creates an editor for another underlying representation of the values. </summary>
    ...
    ///   </list>
    /// </remarks>
    public sealed IEditor<TStored> Converting<TStored>(Func<TStored, T> convert, Func<T, TStored> convertBack) where TStored : unmanaged
