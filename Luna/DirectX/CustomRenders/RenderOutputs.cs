...
public unsafe class RenderOutputs : RenderOutputsBase
{
    ...
    /// <param name="dimensions"> The dimensions of the render outputs. </param>
    ...
    /// <exception cref="ArgumentOutOfRangeException"> <paramref name="dimensions"/> are invalid. </exception>
    /// <exception cref="ArgumentException"> <paramref name="formats"/> is <c>default</c> or specifies too many outputs. </exception>
    public RenderOutputs(Dimensions dimensions, bool generateMips, ImmutableArray<DXGI_FORMAT> formats)
        => SetOutputs(dimensions, generateMips, formats);
    ...
    public RenderOutputs(Dimensions dimensions, bool generateMips, ICustomRenderable renderable)
        => SetOutputs(dimensions, generateMips, renderable);
    ...
    /// <exception cref="ArgumentOutOfRangeException"> <paramref name="dimensions"/> are invalid. </exception>
    /// <exception cref="ArgumentException"> <paramref name="formats"/> is <c>default</c> or specifies too many outputs. </exception>
    public void SetOutputs(Dimensions dimensions, bool generateMips, ImmutableArray<DXGI_FORMAT> formats)
    {
        ArgumentOutOfRangeException.ThrowIfInvalidSize(dimensions);
        ...
        var recreateAll           = dimensions != _dimensions || generateMips != _generateMips;
    ...
    /// <exception cref="ArgumentOutOfRangeException"> <paramref name="dimensions"/> are invalid. </exception>
    /// <exception cref="ArgumentException"> <paramref name="renderable"/> specifies too many outputs. </exception>
    public void SetOutputs(Dimensions dimensions, bool generateMips, ICustomRenderable renderable)
    {
        ...
        SetOutputs(dimensions, generateMips, [..outputFormats]);
    }
    ...
    private void RecreateAllOutputs()
    {
        ...
        DepthStencil = new DepthStencil(CustomRenderManager.Instance.Device, _dimensions);
    ...
    private RenderTarget CreateOutput(int index)
        => new(CustomRenderManager.Instance.Device, _dimensions, _formats[index], _generateMips);
    ...
    public void RenderObject(ICustomRenderable renderable)
    {
        ...
        CustomRenderManager.Instance.RenderObject(renderable, _dimensions, this);
    }
